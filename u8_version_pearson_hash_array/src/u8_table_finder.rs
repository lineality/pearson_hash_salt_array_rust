...
use crate::u8_pearson_hash_salt_array_rust::{
    GENERATED_TABLE, PEARSON_1990_TABLE, pearson_hash_base, pearson_hash_salt_array,
};

use crate::u8_pearson_hash_tools::{
    TableQualityReport, evaluate_table, generate_table_fisher_yates,
};
...
pub fn score_table_on_corpus(
    ...
    let salt_array_collisions: usize = match salt_config {
        ...
        Some(cfg) => {
            ...
            let mut padded_salts: [u8; MAX_SALTS] = [0u8; MAX_SALTS];
...
mod table_finder_tests {
    ...
    use crate::u8_pearson_hash_tools::is_valid_permutation_tools;
